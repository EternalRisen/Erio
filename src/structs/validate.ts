export function checkCommandModule(cmdName: string, cmdModule: {run: () => void, description: string, aliases: string[], type: string, usage: string}) {
	/* eslint-disable */
...
export function checkProperties(cmdName: string, cmdModule: {run: () => void, description: string, aliases: string[], type: string, usage: string}) {
